<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="public.aspx.cs" Inherits="PoliceDepartment._public" %>
...
#slider, #slider div.sliderInner {
    width:900px;height:400px;/* Must be the same size as the slider images */
    background-repeat: no-repeat;
}

#slider {
	background:#fff url(eagle.png) no-repeat 50% 50%;
    background-repeat: no-repeat;
	position:relative;
...
#slider div.mc-caption-bg, #slider div.mc-caption-bg2 {
	...
	width:100%;
	height:auto;
	padding:20px 0;/* 10px will increase the caption background height.*/
...
<body style="background-color:rgb(119, 124, 128)">
    <!--<div style="width:230px; background-color:blue; margin-left:166px;position: fixed;margin-top: 177px;">Hello</div>-->
    <div id="slider" style="margin-left:120px; margin-top:120px;"><img src="../images/do.png" style="background-repeat: no-repeat;width: 740px;height: 416px;margin-top: 85px;border-radius: 10px;margin-left: 292px;">
        <img  src="../images/fl.png" style="background-repeat: no-repeat;width: 46px;;height: 228px;margin-top: -217px;margin-left: 882px;">
       <img src="../images/man_5.jpg"style="background-repeat: no-repeat;width: 46px;;height: 228px;margin-top: -217px;margin-left: 882px;" >
