<%@ page title="" language="C#" masterpagefile="~/Masters/Site.Master" autoeventwireup="true" codebehind="Register.aspx.cs" inherits="PoliceDepartment.Register" %>
    ...
    <tr>
      ...
      <td>
       ...
       <asp:TextBox runat="server" id="txtBoxPassWord" type="PASSWORD" ></asp:TextBox>
         ...
         <tr>
      <td>
     <asp:Label ID="Label3" runat="server" ToolTip="Enter maching password" >Password Again</asp:Label>   
      </td>
        <td>
       <asp:TextBox runat="server"  id="txtPassword2"></asp:TextBox>
        </td>
    </tr>
        <tr>
      <td>
      ...
      <td>
       ...
       <asp:TextBox runat="server" id="txtBoxEye"></asp:TextBox>
        ...
        <tr>
        <td>
            <asp:Button runat="server" Text="Register" ID="btnRegister" OnClick="btnRegister_Click"></asp:Button>
        </td>
        <br /><br />
        <td>
